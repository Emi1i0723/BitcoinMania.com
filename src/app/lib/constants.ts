...
export const STATIC_EDU_CONTENT: Record<string, { explanation: string, analogies: string[], flashcards: { question: string, answer: string }[] }> = {
  ...
  'exchange-vs-wallet': {
    explanation: "1. ¿Qué es un Exchange? (La Casa de Cambio)\nUn Exchange es una plataforma digital (como una aplicación o sitio web) que funciona como un mercado donde puedes comprar y vender criptomonedas usando tu dinero local (Pesos Mexicanos).\nSu función: Es el puente entre el mundo del banco tradicional y el mundo cripto. Entras con pesos y sales con Bitcoin, Ethereum o Solana.\nAnalogía: Imagínalo como una Casa de Cambio en el aeropuerto. Vas con tus pesos, ellos te dan la moneda extranjera (crypto) y se quedan con una pequeña comisión por el servicio.\nEjemplos populares en México: Bitso (el más conocido), Binance o Coinbase.\nDato importante: Mientras tu dinero esté en el Exchange, ellos lo custodian por ti. Es cómodo, pero tú no tienes el control total de las \"llaves\" de ese dinero.\n\n2. ¿Qué es una Wallet? (Tu Billetera Personal)\nUna Wallet (o Cartera Digital) es una herramienta (software o hardware) que te permite almacenar, enviar y recibir tus criptomonedas de forma directa en la blockchain, sin intermediarios.\nSu función: Es donde realmente posees tus activos. Una wallet te entrega unas \"Frases de Recuperación\" (normalmente 12 o 24 palabras). Quien tenga esas palabras, tiene el dinero.\nAnalogía: Es como tu Caja Fuerte personal en casa. Una vez que compras los dólares en la casa de cambio (Exchange), te los llevas a tu caja fuerte (Wallet) donde solo tú tienes la combinación.\n\nTipos de Wallet:\nHot Wallets (Apps): Aplicaciones en tu celular como MetaMask o Phantom (ideal para Solana). Son fáciles de usar pero están conectadas a internet.\nCold Wallets (Hardware): Dispositivos físicos parecidos a un USB (como Ledger o Trezor). Son las más seguras porque están fuera de internet.\nRecomendación de ORO: En Cryptomania recomendamos usar el Exchange para comprar y la Wallet para ahorrar cryptomonedas a largo plazo.",
    analogies: [
  ...
  'price-tracking': {
    explanation: "Para tomar buenas decisiones financieras, es fundamental usar fuentes de datos precisas. Estas son las tres plataformas líderes donde podrás ver no solo el precio de Bitcoin, Ethereum y Solana, sino también descubrir proyectos que acaban de salir al mercado:\n\n1. CoinGecko (Nuestra recomendación)\nEs la plataforma que alimenta nuestra propia calculadora. Es famosa por ser independiente y ofrecer datos muy detallados.\nIdeal para: Ver el precio en Pesos Mexicanos (MXN), seguir el \"market cap\" (tamaño) de cada moneda y descubrir nuevas criptos recién listadas.\nDato extra: Tienen un apartado de \"Recién Añadidas\" donde aparecen los proyectos más nuevos del día.\n\n2. CoinMarketCap\nEs el sitio web de consulta más antiguo y visitado del mundo (propiedad de Binance).\nIdeal para: Comparar el volumen de transacciones entre diferentes exchanges y ver gráficos históricos de hace muchos años.\nVentaja: Su aplicación móvil es excelente para crear una \"Watchlist\" (lista de seguimiento) de tus monedas favoritas.\n\n3. DEX Screener (Para expertos y nuevas gemas)\nSi lo que buscas son criptomonedas que aún no están en las noticias o que acaban de lanzarse en redes como Solana, este es el lugar.\nIdeal para: Rastrear monedas que solo existen en intercambios descentralizados. Aquí es donde se ve el \"pulso\" real del mercado antes de que llegue a las masas.\nPrecaución: Las monedas que aparecen aquí son de altísimo riesgo.\n\n💡 Consejo de Oro\nNo te fíes de una sola fuente. Aunque nuestra calculadora se actualiza cada 30 segundos, siempre es bueno contrastar la información en estas plataformas antes de realizar cualquier movimiento importante.",
    analogies: [
